module.exports = {
      ...
      items: [
        {
          ...
          name: 'Registrate',
          target: '_self',
          callback: 'confirmation_url=%actualLocation%',
        },
        {
        ...
        },
        {
          ...
          key: 'login',
          target: '_self',
          callback: 'platform_id=%platform%&go=%actualLocation%&loginType=explicit',
        },
        {
  ...
  MLB: {
    ...
    footerAccess: { hidden: true },
    footer: {
      navigation: ['helpMain', 'tyc', 'developers', 'investor'],
      social: ['facebook', 'twitter', 'vimeo', 'youtube'],
    },
    styles: {
      useProximaNova: true,
    },
